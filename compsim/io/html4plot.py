...
env = Environment(loader=PackageLoader('compsim.io', 'templates'))
...
class ResultSet(object):
    ...
    def get(self, lambd, alpha, rule):
        ...
        file = "animation.gif" if self.animated else "%d.jpg" % self.last_iteration
...
if __name__ == "__main__":
    ...
    title = "NewSeparationSimulator-3-spread-smallf"
